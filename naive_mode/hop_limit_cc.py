...
if __name__ == "__main__":
	...
	hop_limit_cc = Hop_Limit_CC(settings.filepath, helper.read_binary_file_for_n_packets_and_return_chunks(settings.filepath, settings.stegopackets[0], 1), settings.stegopackets, settings.role, settings.consecutive_clean, settings.consecutive_stego)
